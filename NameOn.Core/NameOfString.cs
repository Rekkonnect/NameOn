...
{
    /// <summary>Represents a string whose assigned expresion is a <see langword="nameof"/> expression.</summary>
    public struct NameOfString : IEquatable<string>, IEquatable<NameOfString>
    {
